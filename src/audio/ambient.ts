...
const CHORD_MAP: Record<number, number[]> = {
  ...
  [DEGREE.II]: [DEGREE.II, DEGREE.V],
  [DEGREE.III]: [DEGREE.I, DEGREE.V],
  [DEGREE.IV]: [DEGREE.I, DEGREE.IV],
  [DEGREE.V]: [DEGREE.II, DEGREE.V],
  [DEGREE.VI]: [DEGREE.I, DEGREE.IV],
  [DEGREE.VII]: [DEGREE.II, DEGREE.V],
};
